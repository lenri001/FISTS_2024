...
\end{table*}	
\begin{table*}[t]
\caption{\centering Riverside Public Utility Commercial Energy Rate \cite{rpu_rate} \\ \centering  Note: The solar surplus rate to sell electricity to the grid is \$0.076 per kWh \cite{rpu_nem}}
\centering
\begin{adjustbox}{max width=\textwidth}
