...
%	Fig \ref{fig:scenario3peakshaving}, \ref{fig:scenario4peakshaving} demonstrate the difficulty that arises when utilizing Level 3 charging compared to Level 2 charging. Fig \ref{fig:scenario3peakshaving} that microgrid sticks to zero most of the with power exports to the grid on a few occasions and small amounts of power import. Fig \ref{fig:scenario4peakshaving} still stays at zero most, but is prone to higher power imports from the gri d to due battery depletion. While the demand peaks vary significantly between level 2 and lavel 3 charging, the overall energy consumption of the microgrid compared to local solar production are similar as seen in Tables \ref{tab:load_level_2_level_3.tex} \ref{tab:mg_gen_level_2_level_3}.
