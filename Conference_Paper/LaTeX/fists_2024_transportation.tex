...
%	\end{table}	
	...
	\end{table*}	
	\begin{table*}[t]
	\caption{Riverside Public Utility Commercial Energy Rate \cite{rpu_rate} \\ Note: The net energy metering rate to sell electricity to the grid is at \$0.076 per kWh \cite{rpu_nem}}
		\normalsize
		\centering
