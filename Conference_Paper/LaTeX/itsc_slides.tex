...
% Define frame title template with anchored logos

\setbeamertemplate{frametitle}{
	\vspace{-0.5ex} % Remove space at the top
	
	\begin{beamercolorbox}[ht=8ex,dp=-1ex,center,wd=16cm]{frametitle} % Adjustable height
		\begin{tikzpicture}[remember picture,overlay]
			% Left logo
			\node[anchor=north west, xshift=1.5em, yshift=-0.2cm] at (current page.north west) {
				\includegraphics[height=2.5em]{aux/CECERT_logo_crop.pdf}
			};
			 Right logo
			 \node[anchor=north east, xshift=-2.5em, yshift=-0.04cm] at (current page.north east) {
				   \includegraphics[height=3em]{aux/itsc_logo.png}
				 };
			 Center title vertically within the box
			\node[anchor=center] at ([yshift=3.7cm]current page.center) {
				\insertframetitle
			};
		\end{tikzpicture}
		\vspace{0.5ex} % Remove space at the top
...
%		\fi
		...
		\begin{tikzpicture}[remember picture,overlay]
			\node[anchor=south west,yshift=6pt,xshift=8pt] at (current page.south west) {\includegraphics[height=1.2cm]{aux/CECERT_logo_crop.pdf}};
		\end{tikzpicture}
		
		\begin{tikzpicture}[remember picture,overlay]
			\node[anchor=south east,yshift=1pt,xshift=-6pt] at (current page.south east) {\includegraphics[height=2cm]{aux/itsc_logo.png}};
		\end{tikzpicture}
	\end{frame}
